        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Created user successfully!");
              window.setTimeout(function () {
                location.assign("/");
              }, 1500);
            }
...
exports.scrollToTop = exports.scrollFunction = exports.changeVideo = void 0;
...
var changeVideo = function changeVideo() {
  ...
  var html = "<div class=\"show-video\">\n                    <video width=\"300\" height=\"200\" controls>\n                      <source src=\"/videos/".concat(this.id, ".mp4\" type=\"video/mp4\">\n                    </video>\n                  </div>\n                  <div class=\"title-video\">\n                    <i class=\"fas fa-play-circle\"></i>\n                    <span class=\"title-name\">Gi\u1EDBi thi\u1EC7u Tr\u01B0\u1EDDng \u0110\u1EA1i h\u1ECDc Vinh</span>\n                    <hr>\n                  </div>");
...
var _doSomeThing = require("./doSomeThing");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
$(".scroll-to-top").on("click", _doSomeThing.scrollToTop);
$(".list-video button").on("click", _doSomeThing.changeVideo);
document.onclick = function (div) {
  var a = div.target.className;
  if (a != "side-bar active" && a != "sub-btn" && a != "fas fa-angle-right dropdown" && a != "fas fa-angle-right dropdown rotate" && a != "fas fa-bars") {
...
var arr_day = ["Chủ nhật", "Thứ hai", "Thứ ba", "Thứ tư", "Thứ năm", "Thứ sáu", "Thứ bảy"];
var today = new Date();
var date = arr_day[today.getDay()] + ", ngày " + today.getDate() + " tháng " + (today.getMonth() + 1) + " năm " + today.getFullYear();
$(".text-date").html(date);
var listDivImg = document.querySelectorAll(".list-img .col div");
...
function setCurrent(index) {
  ...
  listDivImg.forEach(function (item) {
    item.classList.remove("active");
  });

  // set active
  listDivImg[currentIndex].classList.add("active");
  var array = _toConsumableArray(listDivImg);
  $(".list-img .col").empty();
  var a = array.slice(currentIndex, array.length + 1);
...
listDivImg.forEach(function (img, index) {
